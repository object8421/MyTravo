...
urlpatterns = patterns('',
		...
		url(r'^user/password/update$', mviews.UpdatePasswordView.as_view(), name='update_password'),
		url(r'^user/similar$', mviews.GetSimilarUserView.as_view(), name='get_similar'),
