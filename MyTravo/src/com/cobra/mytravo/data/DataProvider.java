...
public class DataProvider extends ContentProvider
{
	...
	public static final String PATH_USERSYNC = "/usersync";

	public static final Uri SHOTS_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY
			+ PATH_SHOTS);
	public static final Uri USERS_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY
			+ PATH_USERS);
	public static final Uri NOTES_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY
			+ PATH_NOTES);
	public static final Uri TRAVELS_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY
			+ PATH_TRAVELS);
	public static final Uri USERSYNC_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY
			+ PATH_USERSYNC);
	...
	private static final int USERSYNC = 5;
	/*
	...
	static
	{
		...
		sUriMatcher.addURI(AUTHORITY, "usersync", USERSYNC);
	}
	...
	private String matchTable(Uri uri)
	{
		...
		case TRAVELS:
			...
			break;
		case USERSYNC:
			table = UserSyncDataHelper.UserSyncInfoDB.TABLE_NAME;
			break;
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
		}
	...
	static class DBHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			...
			UserSyncDataHelper.UserSyncInfoDB.TABLE.create(db);
		}
