 ...
 */
public abstract class SpecialArrayAdapter<T> extends BaseAdapter implements SpecialDynamicListView.Swappable {
	 ...
	 */
	public SpecialArrayAdapter() {
		this(null);
	}

	/**
	 * Creates a new {@link SpecialArrayAdapter} with a <b>copy</b> of the specified
	 * list, or an empty list if items == null.
	 */
	
	public SpecialArrayAdapter(List<T> items) {
