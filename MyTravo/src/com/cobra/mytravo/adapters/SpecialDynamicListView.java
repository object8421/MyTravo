 ...
 */
public class SpecialDynamicListView extends ListView {
	...
	public SpecialDynamicListView(Context context) {
		super(context);
		init(context);
	}

	public SpecialDynamicListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public SpecialDynamicListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (mOnTouchListener instanceof SpecialSwipeOnTouchListener) {
			if (((SpecialSwipeOnTouchListener) mOnTouchListener).isSwiping()) {
	...
	/**
	 * Interface, usually implemented by a {@link com.SpecialBaseAdapterDecorator.listviewanimations.BaseAdapterDecorator},
