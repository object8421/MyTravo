...
public class MyTravelEditActivity extends Activity {
	...
	private String editedTitle, editedExpense, editedDescription, editedStart, editedEnd;
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg){
			switch (msg.what) {
			case SAVE_SUCCESS:
				Toast.makeText(MyTravelEditActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
				MyTravelEditActivity.this.finish();
				break;
			case DELETE_SUCCESS:
				Toast.makeText(MyTravelEditActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
				MyTravelEditActivity.this.finish();
				break;
			default:
				break;
